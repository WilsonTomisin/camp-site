    ...
    <section className=' flexCenter flex-col '>
      <div className=' padding-container max-container w-full pb-24'>
        ...
        <div className=' flex flex-wrap justify-between gap-5 lg:gap-10 '>
            <h1 className=' bold-40 lg:bold-64 xl:max-w-[396px] '>
               Guide You to Easy Path
            </h1>
            <p className=' regular-16 text-gray-30 xl:max-w-[520px]'>
              Only with the hilink application you will
              no longer get lost and get lost again, 
              because we already support offline maps when
              there is no internet connection in the field.
      ...
      <div className=' flexCenter max-container relative w-full'>
        ...
        rounded-3xl border shadow-md md:left-[5%] lg:top-20'>
          <Image src={'/meter.svg'}alt='meter' className=' w-auto h-full'
          height={158} width={15}/>
